describe('Arithmetic', function () {
    ...
    describe('Subtraction', function () {
        it('subtracts two positive integers', function (done) {
            request.get('/arithmetic?operation=subtract&operand1=63&operand2=21')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({ result: 42 });
                    done();
        ...
        it('subtracts two integers resulting in negative', function (done) {
        ...
        it('subtracts using exponential notation', function (done) {
    ...
    describe('Power', function () {
        it('raises a number to an integer power', function (done) {
            request.get('/arithmetic?operation=power&operand1=6&operand2=2')
                .expect(200)
                .end(function (err, res) {
        ...
        it('handles zero base power', function (done) {
